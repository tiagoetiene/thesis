...
\subsection{Topology-aware Isosurfacing}
...
\subsection{Simple Example} Although the previously mentioned problem
...
the Euler characteristic as defined in Equation~\eqref{eq:deltachi}.%\cite{?}.
