...
\includegraphics[width=0.40\linewidth,keepaspectratio=true]{chapter2/figures/all_meshconv-bug.pdf}}
\subfigure{
\label{fig:normconver}
\includegraphics[width=0.40\linewidth,keepaspectratio=true]{chapter2/figures/all_normalconv-bug.pdf}}
\subfigure{
\label{fig:areaconv}
\includegraphics[width=0.40\linewidth,keepaspectratio=true]{chapter2/figures/all_areaconv-bug.pdf}}
\subfigure{
\label{fig:curvatureconv}
\includegraphics[width=0.40\linewidth,keepaspectratio=true]{chapter2/figures/all_curvconv-bug.pdf}}
...
\includegraphics[width=0.40\linewidth,keepaspectratio=true]{chapter2/figures/all_meshconv.pdf}}
\subfigure{
\label{fig:normconver-fixed}
\includegraphics[width=0.40\linewidth,keepaspectratio=true]{chapter2/figures/all_normalconv.pdf}}
\subfigure{
\label{fig:areaconv-fixed}
\includegraphics[width=0.40\linewidth,keepaspectratio=true]{chapter2/figures/all_areaconv.pdf}}
\subfigure{
\label{fig:curvatureconv-fixed}
\includegraphics[width=0.385\linewidth,keepaspectratio=true]{chapter2/figures/all_curvconv.pdf}}
...
\begin{figure}
\centering
\includegraphics[width=0.95\linewidth]{chapter2/figures/teaser.pdf}
