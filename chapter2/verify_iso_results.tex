...
\centering
\subfigure{
\includegraphics[width=0.485\linewidth,keepaspectratio=true]{chapter2/figures/all_meshconv-bug.pdf}}
\subfigure{
\label{fig:normconver}
\includegraphics[width=0.485\linewidth,keepaspectratio=true]{chapter2/figures/all_normalconv-bug.pdf}}
\subfigure{
\label{fig:areaconv}
\includegraphics[width=0.49\linewidth,keepaspectratio=true]{chapter2/figures/all_areaconv-bug.pdf}}
\subfigure{
\label{fig:curvatureconv}
\includegraphics[width=0.48\linewidth,keepaspectratio=true]{chapter2/figures/all_curvconv-bug.pdf}}
\caption{\label{fig:meshconver}Observed order of accuracy. The implementations of 
...
\centering
\subfigure{
\includegraphics[width=0.485\linewidth,keepaspectratio=true]{chapter2/figures/all_meshconv.pdf}}
\subfigure{
\label{fig:normconver-fixed}
\includegraphics[width=0.485\linewidth,keepaspectratio=true]{chapter2/figures/all_normalconv.pdf}}
\subfigure{
...
\includegraphics[width=0.475\linewidth,keepaspectratio=true]{chapter2/figures/all_curvconv.pdf}}
\caption{\label{fig:allconv-fixed}Observed order of accuracy after fixing Macet and Dual Contouring code (other curves remain the same). The black continuous line represents the expected behavior. $p$ is the slope of the linear regression for each curve.}
\end{figure}
