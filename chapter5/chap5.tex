...
%Clearly, our approach is problem-dependent, but its general formulation can be applied not only to isosurfacing and volume rendering, but also to techniques such as streamline computation and mesh simplification. In this paper, however, we focus on direct volume rendering.
...
The interplay between the approximation errors of the inner and outer integrals is non-trivial, and
  ...
  high-order methods.  
  %In this paper, we restrict ourselves to the classic discretization using Riemann sum 
